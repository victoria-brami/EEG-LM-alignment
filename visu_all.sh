...
for list_elt in "FEELING" "SEPARATION" "POLITICS" "ENTERTAINMENT" "MONEY" "NATURE" \
                ...
                "MATERIAL" "GOVERN" "ABSTRACT" "LOCATION"#"FEELING" #"ENTERTAINMENT" "MONEY" "NATURE" "QUANTITY" "RELIGION" "HOUSE" "MOVE" "SPORT" "OBJECT" "ABSTRACT" "FEELING" "INDUSTRY" "SCIENCE" "JUSTICE" "INDUSTRY" "LANGUAGE" "FOOD" "MODE" "DEVICE" "FAMILY" "MUSIC" "CRIME" "CATASTROPHE" "ARMY" "TIME" "SCHOOL" "CLEANNESS" "DEATH" "GLORY" "BODY" "PEOPLE" "MEDICAL" "MATERIAL" "GOVERN"
