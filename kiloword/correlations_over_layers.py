...
def build_source_folder(table_path: str = "",
    ...
    pass
def build_destination_folder(table_path: str = "", distance_type: str = "l2", corr_type: str = "spearman"):
    ...
    dest_file_path = os.path.join(args.save_folder, "image", corr_type, distance_type)
