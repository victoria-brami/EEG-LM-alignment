...
def build_destination_path(
    ...
    if not os.path.exists(
        os.path.join(args.save_folder, "image", corr_type, distance_type)
    ):
        os.makedirs(
            os.path.join(args.save_folder, "image", corr_type, distance_type),
            exist_ok=True,
    ...
    dest_file_path = os.path.join(
        args.save_folder, "image", corr_type, distance_type, f"{corr_type}_{topo_name}"
    )
...
def main(args):
    ...
    pears_dest_file_path = build_destination_path(
        corr.table_path, args.distance, "pearson"
    )
    spear_dest_file_path = build_destination_path(
        corr.table_path, args.distance, "spearman"
    )
