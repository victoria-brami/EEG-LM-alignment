...
do
  for word_dist in "canine_c_random" "canine_s_random" #"canine_c_layer_0" "canine_c_layer_1" "canine_c_layer_2" "canine_c_layer_3" "canine_c_layer_4" #"canine_s" "canine_s_random" "canine_c" "canine_c_random"
  do
    echo $word_dist
